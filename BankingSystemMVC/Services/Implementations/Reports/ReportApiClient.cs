...
namespace BankingSystemMVC.Services.Implementations.Reports
{
    public class ReportApiClient : IReportApiClient
    {
        ...
        public async Task<List<ReportViewModel>> GetMyReportsAsync()
        {
            ...
            return JsonHelper.Deserialize<List<ReportViewModel>>(json) ?? new List<ReportViewModel>();
        }
        ...
        public async Task<ReportViewModel?> GetReportByIdAsync(int id)
        {
            ...
            return JsonHelper.Deserialize<ReportViewModel>(json);
        }
